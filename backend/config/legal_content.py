...
"""
Legal Content for HireLink - Razorpay Compliance (Detailed Version)
"""
...
---
*For support queries, please email us directly or use the chat widget in your dashboard.*
"""
...
*   **Payment Processing**: We use Razorpay for processing payments. We/Razopray do not store your card data on their servers. The data is encrypted through the Payment Card Industry Data Security Standard (PCI-DSS) when processing payment.
...
*   By email: support@hirelink.tech
"""
...
*   **Effect of Cancellation**: If you cancel, your subscription will remain active until the end of the current billing period. You will not be charged for the next billing cycle.

### 2. Refund Eligibility
*   **7-Day Money-Back Guarantee**: We offer a full refund for new subscriptions if requested within **7 days** of the initial purchase date. This allows you to try our service risk-free.
*   **Condition**: To be eligible for a refund, you must submit a request to support@hirelink.tech with your order details within the 7-day window.
*   **After 7 Days**: Requests made after 7 days of the initial purchase are not eligible for a refund, but your subscription can be cancelled to prevent future changes.

### 3. Refund Process
*   Once your return is received and inspected (if applicable) or your request is approved, we will send you an email to notify you of the approval or rejection of your refund.
*   If you are approved, then your refund will be processed, and a credit will automatically be applied to your credit card or original method of payment (via Razorpay), within **5-7 business days**.

### 4. Late or Missing Refunds
If you haven’t received a refund yet, first check your bank account again. Then contact your credit card company, it may take some time before your refund is officially posted. Next, contact your bank. There is often some processing time before a refund is posted. If you’ve done all of this and you still have not received your refund yet, please contact us at support@hirelink.tech.
"""
...
*   **Platform Access**: The service is accessed via our website (hirelink.tech) using your secure login credentials.

### 2. Delivery Timeline
*   **Immediate Access**: Upon successful payment confirmation, your account is automatically upgraded to the premium plan immediately. You should receive access to all paid features within **5-15 minutes** of the transaction.
*   **Confirmation**: An email confirmation containing your invoice and subscription details will be sent to your registered email address instantly upon payment success.

### 3. Proof of Delivery
*   For any issues regarding the activation of your plan, the email confirmation sent to your registered email address serves as the proof of delivery.
*   If you do not receive the confirmation email or access to premium features after payment, please contact our support team at support@hirelink.tech immediately with your transaction ID.
"""
